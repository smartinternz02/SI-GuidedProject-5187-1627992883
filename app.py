...
def check(email):
    url = "https://lhj24p2ka6.execute-api.us-west-2.amazonaws.com/plasma/getdata?email="+email
...
def register():
    ...
    if('errorType' in check(x[1])):
        url = " https://lhj24p2ka6.execute-api.us-west-2.amazonaws.com/plasma/registration?"+params
...
@app.route('/stats')
def stats():
    url = " https://lhj24p2ka6.execute-api.us-west-2.amazonaws.com/plasma/getbloodgroupsdata"
    response = requests.get(url)
    r = response.json()
    print(r)
...
def requested():
    ...
    print(address)
    url = " https://lhj24p2ka6.execute-api.us-west-2.amazonaws.com/plasma/requestonbloodgroup?blood="+bloodgrp
    status = requests.request("GET",url)
    a=status.json()
    print(a)
    phone=[]
